...
const components: ComponentItem[] = [
  {
    ...
    image: '/previews/project-card.svg',
    category: 'Cards',
  ...
  },
  {
    ...
    image: '/previews/navigation-bar.svg',
    category: 'Navigation',
    languages: ['TypeScript', 'JavaScript', 'Python'],
    technologies: ['React', 'Material UI', 'Flask'],
  ...
  },
  {
    ...
    image: '/previews/filter-chips.svg',
    category: 'Inputs',
  ...
  },
  {
    ...
    image: '/previews/loading-button.svg',
    category: 'Feedback',
    languages: ['TypeScript', 'JavaScript'],
    technologies: ['React', 'Material UI'],
  ...
  },
  {
    ...
    image: '/previews/profile-menu.svg',
    category: 'Navigation',
    languages: ['TypeScript', 'JavaScript'],
    technologies: ['React', 'Material UI'],
